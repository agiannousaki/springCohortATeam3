...
public class SampleContentCreator extends BaseComponent implements CommandLineRunner {
    ...
    public void run(final String... args) throws Exception {
        ...
        List<Person> persons = List.of(
                Person.builder().firstName("Angeliki").lastName("Giannousaki").placeOfBirth("Russia").dateOfBirth(new Date(31556952000L)).biography("two Academy Awards, two Golden Globe Awards, and three British Academy Film Awards").build(),
